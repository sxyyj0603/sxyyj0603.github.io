...
\begin{enumerate}
\item \red{Bates, S.*, Cand\`{e}s, E. J.*, \textbf{Lei, L.}*, Romano, Y.*, and Sesia, M.* (2022+) Testing for Outliers with Conformal p-values. \emph{ArXiv e-prints, abs/2104.08279}. To appear in \emph{Annals of Statistics (AoS)}.}
\item \red{Cand\`{e}s, E. J.*, \textbf{Lei, L.}*, Ren, Z.* (2022+) Conformalized Survival Analysis. \emph{ArXiv e-prints, abs/2103.09763}. To appear in \emph{Journal of the Royal Statistical Society: Series B (JRSS-B)}.}
\item \red{Horv\'{a}th, S.*, \textbf{Lei, L.}*, Richt\'{a}rik, P., and Jordan, M. I. (2022) Adaptivity of Stochastic Gradient Methods for Nonconvex Optimization. \emph{SIAM Journal on Mathematics of Data Science (SIMODS)}, 4(2), 634-648.}
\item \red{Fithian, W. and \textbf{Lei, L.} (2022) Conditional calibration for false discovery rate control under dependence. To appear in \emph{Annals of Statistics (AoS)}.}
...
\begin{enumerate}
\item \red{Arkhangelsky, D.*, Imbens, G. W.*, \textbf{Lei, L.}*, and Luo, X.* (2022) Double-Robust Two-Way-Fixed-Effects Regression For Panel Data. \emph{Arxiv e-prints, abs/2107.13737}. Under R\&R at \emph{Quantitative Economics (QE)}.}
\end{enumerate}
...
\begin{enumerate}
\item \red{Sahoo, R., \textbf{Lei, L.}, and Wager, S. (2022) Learning from a Biased Sample. \emph{Arxiv e-prints, abs/2209.01754}.}
\item \red{Marandon, A., \textbf{Lei, L.}, Mary, D., and Roquain, R. (2022) Machine learning meets false discovery rate. \emph{Arxiv e-prints, abs/2208.06685}.}
\item \red{Luo, Y., Fithian, W, and Lei, L. (2022) Improving knockoffs with conditional calibration. \emph{Arxiv e-prints, abs/2208.09542}.}
\item \red{Angelopoulos, A.*, Bates, S.*, Fisch, A.*, \textbf{Lei, L.}*, and Schuster T.* (2022) Conformal Risk Control. \emph{Arxiv e-prints, abs/2208.02814}.}
